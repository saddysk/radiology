...
import { BookingDto, BookingRecordDto } from "@/app/api/data-contracts";
  ...
  return (
    <div className="w-full h-[85vh] p-8 overflow-y-scroll">
      <div className="w-full flex">
        <Link href={`/pr/${centreId}/bookings/add`}>
        ...
        <Table>
          {dataCentreBookings?.data.length == 0 && (
            <TableCaption className="py-6">
              ...
              <Link className="underline" href={`/pr/${centreId}/bookings/add`}>
                Here{" "}
              </Link>
            </TableCaption>
          )}
